	...
	<div class="db">
		<div class="b e">
			...
			<div class="d hx hf gu gallery-item gallery-expand ce overhead">
				<div class="gallery-curve-wrapper">
					<a class="gallery-cover gray" style="height: 300px;">
						<img src="//cdn.shopify.com/s/files/1/1775/8583/t/1/assets/overhead.jpg?v=36836431726999705681487049721" crossOrigin="anonymous" alt="placeholder">
					</a>
			...
			<div class="d hx hf gu gallery-item gallery-expand ce overhead">
				<div class="gallery-curve-wrapper">
					<a class="gallery-cover gray" style="height: 400px;">
						<img src="//cdn.shopify.com/s/files/1/1775/8583/t/1/assets/overhead2.jpg?v=82468156401975510361487049743" crossOrigin="anonymous" alt="placeholder">
					</a>
					<div class="gallery-header">
						<span>Studio</span>
					</div>
			...
			<div class="d hx hf gu gallery-item gallery-expand ce sintel">
				<div class="gallery-curve-wrapper">
					<a class="gallery-cover gray" style="height: 300px;">
						<img src="//cdn.shopify.com/s/files/1/1775/8583/t/1/assets/sintel-bamboo.jpg?v=120240807786129170731487049819" crossOrigin="anonymous" alt="placeholder">
					</a>
					<div class="gallery-header">
						<span>Bamboo</span>
					</div>
			...
			<div class="d hx hf gu gallery-item gallery-expand ce sintel">
				<div class="gallery-curve-wrapper">
					<a class="gallery-cover gray" style="height: 300px;">
						<img src="//cdn.shopify.com/s/files/1/1775/8583/t/1/assets/sintel-bedroom.png?v=177013730214132222671487049838" crossOrigin="anonymous" alt="placeholder">
					</a>
					<div class="gallery-header">
						<span>Bedroom</span>
					</div>
			...
			<div class="d hx hf gu gallery-item gallery-expand ce overhead">
				<div class="gallery-curve-wrapper">
					<a class="gallery-cover gray" style="height: 350px;">
						<img src="//cdn.shopify.com/s/files/1/1775/8583/t/1/assets/overhead3.jpg?v=178693917645316020391487049766" crossOrigin="anonymous" alt="placeholder">
					</a>
					<div class="gallery-header">
						<span>Workshop</span>
					</div>
			...
			<div class="d hx hf gu gallery-item gallery-expand ce overhead">
				<div class="gallery-curve-wrapper">
					<a class="gallery-cover gray" style="height: 400px;">
						<img src="//cdn.shopify.com/s/files/1/1775/8583/t/1/assets/overhead5.jpg?v=156243516395950531531487049783" crossOrigin="anonymous" alt="placeholder">
					</a>
					<div class="gallery-header">
						<span>Kitchen</span>
					</div>
			...
			<div class="d hx hf gu gallery-item gallery-expand ce sintel">
				<div class="gallery-curve-wrapper">
					<a class="gallery-cover gray" style="height: 300px;">
						<img src="//cdn.shopify.com/s/files/1/1775/8583/t/1/assets/sintel-snowscape.jpg?v=121424784257463231001487049831" crossOrigin="anonymous" alt="placeholder">
					</a>
					<div class="gallery-header">
						<span>Snowscape</span>
					</div>
			...
			<div class="d hx hf gu gallery-item gallery-expand ce overhead">
				<div class="gallery-curve-wrapper">
					<a class="gallery-cover gray" style="height: 250px;">
						<img src="//cdn.shopify.com/s/files/1/1775/8583/t/1/assets/overhead4.jpg?v=132440278429706872481487049775" crossOrigin="anonymous" alt="placeholder">
					</a>
					<div class="gallery-header">
